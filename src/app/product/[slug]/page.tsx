      ...
      <div className="p-6">
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            ...
            <h1 key={index} className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl my-4">{product.name}</h1>
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            <p key={index} className="text-3xl tracking-tight text-gray-900 font-bold">{product.price}</p>
          ...
          <div className="mt-4 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
              <h3 key={index} className="text-xl font-medium text-gray-900">{product.text}</h3>
